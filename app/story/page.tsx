    ...
    <main className="story-page">
      ...
      <section className="faq-section">
        ...
        <div className="faq-list">
          ...
          <details><summary>Како се одвива плаќањето?</summary><p>Плаќањето се одвива само кога ќе ви го достави курирот, нема опција засега за онлајн плаќање. Каргото е најчесто 180ден.</p></details>
          <details><summary>Дали има бесплатна достава?</summary><p>Доколку сте од Битола или Скопје, обратете ни се во порака на инстаграм, може да се договореме да ви го донесеме ние пакетчето до дома, бидејќи најчесто сме во тие два града.</p></details>
